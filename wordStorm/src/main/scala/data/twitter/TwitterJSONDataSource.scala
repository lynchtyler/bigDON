...
/**
  ...
  * data and allows access to the linguistic twitter data contained within the Twitter [[Source]]
  * file.
  *
...
class TwitterJSONDataSource(val sourceFile: Source) extends DataSource[JSON] {
  ...
  /**
    * Gets the data stream of the linguistic data from the [[Source]] that is a candidate for
    * linguistic analysis.
    *
